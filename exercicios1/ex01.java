...
public class ex01 {
    public static void main(String[] args) {
        ...
        DecimalFormat df = new DecimalFormat("0.00");// classe p formatação entre aspas é definido que será trabalhado
                                                     // com casas decimais
        ...
        System.out.println("valor do desconto do primeiro empregado: " + df.format(desconto));// ln = \n
        System.out.println("valor do aumento do segundo empregado: " + df.format(acrescimo));
